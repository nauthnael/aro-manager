...
export default function StatsCards({ stats, activeFilter, onFilter }: Props) {
  ...
  const statusCards = [
    ...
    { key: 'Offline',       label: 'ARO Offline',   value: stats.offline,             border: 'border-red-500' },
    { key: 'proxy_expired', label: 'Proxy Expired', value: stats.proxy_expired ?? 0,  border: 'border-orange-500' },
    { key: 'no_exit_ip',    label: 'Cần Active',    value: stats.no_exit_ip_count ?? 0, border: 'border-red-400' },
