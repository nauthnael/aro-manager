...
VALID_ACTIONS = {"proxy_test", "restart_aro", "restart_watchdog", "debug_aro", "reboot_vps", "capture_screenshot", "update_script", "install_scrot", "renew_node", "tele_off", "tele_on", "set_proxy", "set_tg_chatid", "set_tg_token", "combo_purge_proxy_renew"}
